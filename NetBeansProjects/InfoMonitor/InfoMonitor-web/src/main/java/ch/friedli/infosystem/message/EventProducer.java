...
public class EventProducer {
    ...
    @Schedule(second = "*/30", minute = "*", hour = "*", info = "Locker Room Event publisher")
    ...
    @Schedule(second = "*/50", minute = "*", hour = "*", info = "Latest Result Event publisher")
    ...
    //@Schedule(dayOfWeek = "6,7", second = "*", minute = "*/3", hour = "*", info = "Totomat Event publisher")
    ...
    @Schedule(second = "*/20", minute = "*", hour = "*", info = "BreakingNews Event publisher")
